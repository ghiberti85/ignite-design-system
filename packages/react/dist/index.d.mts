...
declare function Toast({ title, description, children, defaultOpen, }: ToastProps): react_jsx_runtime.JSX.Element;

interface TooltipProps extends ComponentProps$1<typeof Root> {
    contentValue: string;
    isOpened: boolean;
}
declare function Tooltip({ contentValue, children, isOpened }: TooltipProps): react_jsx_runtime.JSX.Element;
